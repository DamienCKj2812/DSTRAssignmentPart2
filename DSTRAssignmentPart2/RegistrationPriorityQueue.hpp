#ifndef REGISTRATION_PRIORITY_QUEUE_BY_HPP
#define REGISTRATION_PRIORITY_QUEUE_BY_HPP
...
private:
    ...
    bool isLowerPriority(const T& a, const T& b) {
        // Lower regType value = higher priority
        if (a.getRegistrationType() != b.getRegistrationType()) {
            return a.getRegistrationType() < b.getRegistrationType();
        }
        // If same registration type, compare by ranking
